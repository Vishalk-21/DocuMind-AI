    ...
    await transporter.sendMail({
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 520px; margin: 0 auto; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px; background: #f8fafc;">
                ...
                <div style="padding: 18px 20px; border-radius: 10px; background: #111827; color: white; font-size: 32px; letter-spacing: 8px; text-align: center; font-weight: 700; margin: 16px 0;">
                    ${otp}
                </div>
